...
def bisection_Nc_general(Xtot, n_rep, Nmin, Nmax, p_tol, seed, verbose=False):
    ...
    #?100
    #?(Pdb) p f_pdiff
    #?<function bisection_Nc_general.<locals>.create_f_pdiff.<locals>.f_pdiff at 0x155490450160>
...
def compute_sep_Nc_general(Xtot, N_cur, n_rep, seed, reduced=False):
    ...
    for i in range(n_rep):
        if i % 50 == 0:
            print(f"Current [{i}/{n_rep}] of simulated capacity calculation")
